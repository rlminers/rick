...
set long 40000 longchunksize 20000 pagesize 0 linesize 1000 feedback off verify off trimspool on
...
-- &&user_name
exec:v_username := upper('&&user_name');
spool user_ddl_&user_name..sql
